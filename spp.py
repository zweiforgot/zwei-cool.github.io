...
def smb():
    ...
    path3 = 'file:///C:/Users/' + getpass.getuser() + '/Downloads/SuperMarioBros/index.html'
...
def eldrich():
    print('I am Sparkplug Cadet, come get your unblocked games here. I have unblocked games all day, everyday. Unblocked Games. Unblocked Games. Unblocked Games.')
    print('Return to Sparkplug Cadet again and maybe I will tell you a story.')
...
print(colored("     6", 'cyan'), ("    >>     Test                                "))
print(colored("     7", "cyan"), ("    >>     Login as Admin                      "))
print(colored("----------------------------------------------------------------------------------------------------", 'cyan'))
